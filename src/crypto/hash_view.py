...
from ui.components import IconButton, PrimaryButton, TextField
...
class HashView(BaseView):
    ...
    def _fill_input_from_digest(self, inp: TextField, digest: TextField):
